...
### 방법 A: AI 비서에게 알아서 하라고 시키기 (가장 추천!)
복잡하게 폴더를 만들고 복사하실 필요가 없습니다. 개발을 시작할 때 AI(예: Claude Code, AI 에이전트 등)에게 딱 한마디만 하세요.
> *"나 이번에 아이폰 앱(또는 파이썬 봇) 하나 만들 건데, `AI_Settings` 리포지토리(창고)에 가서 필요한 언어 규칙서 쏙쏙 뽑아서 새 프로젝트 폴더에 세팅부터 먼저 해줘!"*
-> 그러면 AI가 알아서 창고를 뒤져 필요한 언어팩을 가져와 세팅을 끝냅니다!
